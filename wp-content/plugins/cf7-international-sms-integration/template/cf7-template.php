<div id="cf7si-sms-sortables" class="meta-box-sortables ui-sortable">
	<h3><?php _e("Admin SMS Notifications",CF7SI_TXT); ?></h3>
	<fieldset>
		<legend><?php _e("In the following fields, you can use these tags:",CF7SI_TXT); ?>
			<br />
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="wpcf7-sms-recipient"><?php _e("To:",CF7SI_TXT); ?></label>
					</th>
					<td>
						<input type="text" id="wpcf7-sms-recipient" name="wpcf7si-settings[phone]" class="wide" size="70" value="<?php echo $data['phone']; ?>">
						<br/> <?php _e("<small>Enter Numbers By <code>,</code> for multiple</small>",CF7SI_TXT); ?>
					</td>
				</tr>

				<tr>
					<th scope="row">
						<label for="wpcf7-mail-body"><?php _e("Message body:",CF7SI_TXT); ?></label>
					</th>
					<td>
	...
	<hr/>
	<h3><?php _e("Visitor SMS Notifications",CF7SI_TXT); ?></h3>
	<fieldset>
		<legend><?php _e("In the following fields, you can use these tags:",CF7SI_TXT); ?>
			<br />
			<?php $data['form']->suggest_mail_tags(); ?>
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th scope="row">
						<label for="wpcf7-sms-recipient"><?php _e("Visitor Mobile: ",CF7SI_TXT); ?></label>
					</th>
					<td>
						...
						<br/> <?php _e("<small>Use <b>CF7 Tags</b> To Get Visitor Mobile Number | Enter Numbers By <code>,</code> for multiple</small>",CF7SI_TXT);?>
					</td>
				</tr>
